const mailBrand = {
  ...
  card: "#EEE8DA",
  darkBlue: "#466997",
  logoUrl: "https://heinzelchen.com/assets/heinzelchen-logo-transparent.png",
};
...
function mailButton({ href, label }) {
  return `<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;margin:24px 0 22px;">
    <tr>
      <td bgcolor="${mailBrand.darkBlue}" style="border-radius:999px;background:${mailBrand.darkBlue};">
        <a href="${href}" style="display:inline-block;padding:14px 22px;color:#FFFFFF;background:${mailBrand.darkBlue};border-radius:999px;font-family:Georgia,'Times New Roman',serif;font-size:17px;font-weight:700;line-height:1.25;text-decoration:none;">${label}</a>
      </td>
    </tr>
  </table>`;
}
