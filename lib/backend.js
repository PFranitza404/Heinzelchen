    ...
    sendEmail({
      ...
      html: renderMailLayout({
        ...
        children: `
          ...
          ${mailParagraph(`wir haben ein Heinzelchen für Sie gefunden. ${escapeHtml(workerFirstName)} kann am ${escapeHtml(date)} um ${escapeHtml(time)} zu Ihnen kommen und verlangt ${hourlyRate} pro Stunde. Wissen Sie Ihre Aufgabe in guten Händen und bestätigen Sie Ihren Auftrag mit der Zahlung der Vermittlungsgebühr.`)}
